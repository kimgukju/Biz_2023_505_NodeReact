...
// import { bucketLoader, bucketAction } from "../moduels/routerAction";
import BucketDetail, {
  detailLoader,
  deleteAction,
  completeAction,
...
import BucketComplete from "../comps/BucketComplete";

/**
 * RouterProvider 에 연결하여 각종 Routing 을 수행하는 설정 만들기
